...
def load_data(symbol: str = "005930.KS", start_date: str = "2000-01-01", end_date: str = "2025-12-31") -> pd.DataFrame:
    """데이터 로드"""
...
def main():
    ...
    # 데이터 로드
    data = load_data("005930.KS", "2000-01-01", "2025-12-31")
    ...
    # 7. 예측 결과 CSV 저장
    final_data.to_csv('backtest_results.csv')
    print("\n✅ 백테스트 완료! 결과가 'backtest_results.csv'에 저장되었습니다.")
